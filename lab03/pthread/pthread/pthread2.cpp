/*
 * File: pthread/pthread2.cpp
 * Author: Ethan
 * Date: 2024-5-24
 * Description: pthread 静态线程 + 信号量
 *
 * Usage: g++ -o pthread2 .\pthread2.cpp -pthread
 *
 * Note: 该版本为纯pthread普通高斯消去
 */
...
void threadMain()
{
    ...
    threadParam_t param[thread_num]; // 创建对应的参数
    for (int t_id = 0; t_id < thread_num; t_id++)
    {
...
int main()
{
    ...
    cout << "n=" << N << " pthread2 :  " << timeuse / times << "ms" << endl;
