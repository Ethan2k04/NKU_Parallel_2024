/*
 * File: col/pthread3_col.cpp
 * Author: Ethan
 * Date: 2024-5-25
 * Description: pthread 静态线程 + 信号量 + 三重循环全部纳入线程函数
 *
 * Usage: g++ -o pthread3_col .\pthread3_col.cpp -pthread
 *
...
int main()
{
    ...
    cout << "n=" << N << " pthread3_Col: " << timeuse / times << "ms" << endl;
