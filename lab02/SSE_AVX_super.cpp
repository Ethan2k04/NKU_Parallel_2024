...
string act_name[] = {"./data/103/act.txt", "./data/254/act.txt", "./data/562/act.txt", "./data/1011/act.txt", "./data/2362/act.txt", "./data/3799/act.txt", "./data/8399/act.txt", "./data/23045/act.txt", "./data/37960/act.txt", "./data/43577/act.txt", "./data/37960/act.txt"};
string pas_name[] = {"./data/103/pas.txt", "./data/254/pas.txt", "./data/562/pas.txt", "./data/1011/pas.txt", "./data/2362/pas.txt", "./data/3799/pas.txt", "./data/8399/pas.txt", "./data/23045/pas.txt", "./data/37960/pas.txt", "./data/23045/act.txt", "./data/37960/act.txt"};
...
int main()
{
    ...
    */
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        time1 = ((tail.tv_sec - head.tv_sec) * 1000000 + (tail.tv_usec - head.tv_usec)) / 1000.0; // 单位 ms
        cout << "serial time: " << time1 << " ms" << endl;
        ...
        f_sse();
        gettimeofday(&tail, NULL);                                                                // 结束计时
        time2 = ((tail.tv_sec - head.tv_sec) * 1000000 + (tail.tv_usec - head.tv_usec)) / 1000.0; // 单位 ms
        cout << "SSE_super time: " << time2 << " ms" << endl;
        ...
        f_avx256();
        gettimeofday(&tail, NULL);                                                                // 结束计时
        time3 = ((tail.tv_sec - head.tv_sec) * 1000000 + (tail.tv_usec - head.tv_usec)) / 1000.0; // 单位 ms
        cout << "AVX256_super time: " << time3 << " ms" << endl;
    }
